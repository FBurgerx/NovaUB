...
**NovaUB** — это многофункциональный Telegram userbot, разработанный для автоматизации задач и расширения возможностей Telegram. Проект предоставляет гибкую модульную архитектуру, позволяющую легко добавлять новые функции и настраивать бота под свои нужды.
...
NovaUB использует гибкую систему загрузки модулей с поддержкой:
...
NovaUB включает интерактивную CLI-панель для управления ботом.
